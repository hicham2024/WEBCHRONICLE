...
def rss():
    ...
    body = f"<?xml version=\"1.0\" encoding=\"UTF-8\"?><rss version=\"2.0\"><channel><title>WebChronicle</title><link>{html.escape(FRONTEND_URL)}</link><description>web preservation, page snapshot, screenshot, link rot</description>" + ''.join(items) + "</channel></rss>"
